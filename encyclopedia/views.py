...
def new_page(request):
    ...
    create new page
    steps:
    1. grt page tittle and body from NewPageForm
    2. check if the page already exsist in disk
    3. if page title exsist display error massage
    4. if not save new page and redirect to get_page with title_name
    '''
    if request.method == "GET":
